...
{
    double width,height;// double instance variable
    ...
    public Wall()// constructor with zero arguments
    {

    }

    public Wall(double width, double height)// constructor with two arguments
    {
        if(width<0 && height>0){
            this.height= height;
            this.width=0;
    ...
    public double getWidth()// (instance method) return method with no parameter
    {
        return width;
    }

    public double getHeight()// (instance method) return method with no parameter
    {
        return height;
    }

    public void setWidth(double width) // (instance method) no return method with one parameter
    {
        if (width<0){
            this.width=0;
    ...
    public void setHeight(double height)// (instance method) no return method with one parameter
    {
        if(height<0){
            this.height= 0;
    ...
    public double getArea()// (instance method) return method with no parameter
    {
